...
module Druid
  module Accessors
    ...
    #
    # specify the method to use when navigating to another page via this class
    #
    # @param [Symbol] a method name that takes no parameters and will complete this page and navigate to the next
