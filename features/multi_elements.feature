Feature: Multi Elements
   ...
   Scenario: Selecting links
     ...
     And I should be able to find 3 links using no identifier
   ...
   Scenario: Selecting checkboxes
     ...
     And I should be able to find 3 checkboxes using no identifier
   ...
   Scenario: Selecting radio buttons
     ...
     And I should be able to find 3 radio buttons using no identifier
   ...
   Scenario: Selecting divs
     ...
     And I should be able to find 3 divs using no identifier
   ...
   Scenario: Selecting spans
     ...
     And I should be able to find 3 spans using no identifier
